...
/* A class object. It holds the name of the class and a table of methods the class declares */
typedef struct {
    FalconObj obj;
    ObjString *name;
    Table methods;
...
/* A class instance object. It holds its related class and a table of fields that the instance
 * owns */
typedef struct {
    FalconObj obj;
    ObjClass *class_;
...
/* A map object. It holds a hashtable of FalconValue entries, where only ObjStrings can be keys,
 * and the current length of the map */
typedef struct {
    FalconObj obj;
    Table entries;
    uint16_t length;
